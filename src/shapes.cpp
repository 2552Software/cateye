...
void Game::credits(bool signon) {
   ...
   // fancyText.addFullScreenText(TextTimer("fast for testing", 1000.0f, 0.0f, 0.0f));
    ...
    if (signon || (int)ofRandom(0, 10) > 2) {
        ...
        fancyText.addFullScreenText(TextTimer("Thank Can Can Wonderland ...", 500.0f, 500.0f, 2.0f));
        fancyText.addFullScreenText(TextTimer("... For their support of the Arts!", 500.0f, 500.0f, 3.0f));
    }
    else {
