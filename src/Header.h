...
#define MAXLEVELS 4
    ...
    GameLevel() : durations{180* frameRate, 10 * frameRate, 15 * frameRate, 20 * frameRate } // measured in number of calls to update, about 15/second if that is the frame rate
    { setup(NoGame);  }
